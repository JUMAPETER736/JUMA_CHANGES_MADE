...
//        con = context;
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.messageSendButton) {
            ...
            onAddVoiceNote();
            if (!isVnRecording) {
                voiceMessageButton.setImageDrawable(style.getStopVoiceMessageButtonIcon());
                isVnRecording = true;
            } else {
...
//        Log.d("Attachment", "Attachment Listener");
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.gifButton.getLayoutParams().width = style.getAttachmentButtonWidth();
        this.gifButton.getLayoutParams().height = style.getAttachmentButtonHeight();
