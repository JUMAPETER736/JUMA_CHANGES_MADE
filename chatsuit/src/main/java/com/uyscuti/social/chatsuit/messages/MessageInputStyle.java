...
import com.uyscuti.social.chatsuit.commons.Style;
...
class MessageInputStyle extends Style {
    ...
    private int gifButtonWidth;
    private int gifButtonHeight;
    private int gifButtonMargin;
    ...
    static MessageInputStyle parse(Context context, AttributeSet attrs) {
        ...
        style.gifButtonWidth = typedArray.getDimensionPixelSize(R.styleable.MessageInput_gifButtonWidth, style.getDimension(R.dimen.gif_button_width));
        style.gifButtonHeight = typedArray.getDimensionPixelSize(R.styleable.MessageInput_gifButtonHeight, style.getDimension(R.dimen.input_button_height));
        style.gifButtonMargin = typedArray.getDimensionPixelSize(R.styleable.MessageInput_attachmentButtonMargin, style.getDimension(R.dimen.input_button_margin));
        ...
        style.emojiButtonIcon = typedArray.getResourceId(R.styleable.MessageInput_MessageInput_emojiButtonIcon, -1);
        style.emojiButtonDefaultIconColor = typedArray.getColor(R.styleable.MessageInput_MessageInput_emojiButtonDefaultIconColor,
                style.getColor(R.color.cornflower_blue_two));

        style.emojiButtonDefaultBgPressedColor = typedArray.getResourceId(R.styleable.MessageInput_MessageInput_emojiButtonDefaultIconPressedColor,
                style.getColor(R.color.cornflower_blue_two_dark));

        style.emojiButtonDefaultBgDisabledColor = typedArray.getResourceId(R.styleable.MessageInput_MessageInput_emojiButtonDefaultIconDisabledColor,
                style.getColor(R.color.white_four));
    ...
    private Drawable getSelector(@ColorInt int normalColor, @ColorInt int pressedColor,
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.CUPCAKE) {
            drawable = DrawableCompat.wrap(getVectorDrawable(shape)).mutate();
        }
...
//    }
    ...
    protected int getGifButtonWidth() {
        return gifButtonWidth;
    }
    ...
    protected int getGifButtonHeight() {
        return gifButtonHeight;
    }
...
//    }
    ...
    protected Drawable getInputButtonIcon() {
        if (inputButtonIcon == -1) {
            return getSelector(inputButtonDefaultIconColor, inputButtonDefaultIconPressedColor,
                    inputButtonDefaultIconDisabledColor, R.drawable.send_svgrepo_com__1_);
        } else {
    ...
    protected Drawable getAttachmentButtonIcon() {
        if (attachmentButtonIcon == -1) {
            return getSelector(inputButtonDefaultIconColor, inputButtonDefaultIconPressedColor,
                    inputButtonDefaultIconDisabledColor, R.drawable.ic_add_attachment);
        } else {
            return getDrawable(attachmentButtonIcon);
        }
    }
    ...
    protected Drawable getStopVoiceMessageButtonIcon() {
        return getSelector(inputButtonDefaultIconColor, inputButtonDefaultIconPressedColor,
                inputButtonDefaultIconDisabledColor, R.drawable.baseline_stop_24);
    }

    protected Drawable getVoiceButtonIcon() {
        if (inputButtonIcon == -1) {
            return getSelector(inputButtonDefaultIconColor, inputButtonDefaultIconPressedColor,
                    inputButtonDefaultIconDisabledColor, R.drawable.mic_1);
        } else {
            return getDrawable(inputButtonIcon);
        }
    }
