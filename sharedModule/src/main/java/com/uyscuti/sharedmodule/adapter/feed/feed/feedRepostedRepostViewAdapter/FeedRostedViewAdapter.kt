package com.uyscuti.sharedmodule.adapter.feed.feed.feedRepostedRepostViewAdapter
...
class FeedRostedViewAdapter (fragmentActivity: FragmentActivity,
   private val feedPost: com.uyscuti.social.network.api.response.allFeedRepostsPost.OriginalPost
) :
