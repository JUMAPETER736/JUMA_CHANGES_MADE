...
class CommentAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(
            R.layout.comment_text_item, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val likeLinearLayout: TextView = itemView.findViewById(R.id.likeButton)
        ...
        private fun navigateToUserProfile(author: Author?) {
            ...
            val currentUserId = LocalStorage.Companion.getInstance(itemView.context).getUserId()
            ...
            if (feedOwnerId == currentUserId) {
                ...
                OtherUserProfileAccount.open(itemView.context,
                    otherUsersProfile,
                    profilePicUrl,
                    feedOwnerId
                    )
