package com.uyscuti.sharedmodule.adapter.shorts
...
import com.uyscuti.sharedmodule.cache.objectcache.CacheManager
import com.uyscuti.sharedmodule.cache.objectcache.DiskCache
import com.uyscuti.sharedmodule.cache.objectcache.PutCallback
import com.uyscuti.sharedmodule.databinding.AudioCommentItemReplyBinding
import com.uyscuti.sharedmodule.databinding.DocumentCommentItemReplyBinding
import com.uyscuti.sharedmodule.databinding.ImageCommentItemReplyBinding
import com.uyscuti.sharedmodule.databinding.TextCommentReplyBinding
import com.uyscuti.sharedmodule.databinding.VideoCommentItemReplyBinding
...
class ReplyCommentAdapter(
    ...
    init {
        ...
        cacheFile = File(cachePath + separator + "com.uyscuti.social.flashdesign")
    ...
    inner class GifViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val binding = ImageCommentItemReplyBinding.bind(itemView)
        ...
        fun bind(currentItem: Comment) {
            binding.apply {
                ...
                val regex = Regex("@\\w+")
                val matches = regex.findAll(inputString.toString())
                if (matches.none()) {
    ...
    inner class AudioViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val binding = AudioCommentItemReplyBinding.bind(itemView)
        ...
        fun bind(currentItem: Comment) {
            binding.apply {
                ...
                val commentReply = com.uyscuti.social.network.api.models.Comment(
                    ...
                    progress = currentItem.progress ?: 0f,
                    isPlaying = currentItem.isPlaying == true,
                    localUpdateId = data.localUpdateId
                )
                ...
                if (currentItem.fileType == "vnAudio") {
                    CoroutineScope(Dispatchers.IO).launch {
                        ...
                        CoroutineScope(Dispatchers.Main).launch {
                            ...
                            wave.progress = currentItem.progress ?: 0f
                    ...
                    commentAudioSeekBar.progress = currentItem.progress?.toInt() ?: 0
    ...
    fun setSecondSeekBarProgress(progress: Float, position: Int) {
        Log.d(
            ...
            "secondCurrentSeekBar $progress,,, position $position"
        )
    ...
    inner class TextViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val binding = TextCommentReplyBinding.bind(itemView)
    ...
    inner class VideoViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val binding = VideoCommentItemReplyBinding.bind(itemView)
    ...
    inner class DocumentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val binding = DocumentCommentItemReplyBinding.bind(itemView)
    ...
    fun changeReplyAudioPlayingStatus() {
        ...
        for (i in itemList.indices) {
            ...
            if (item.isPlaying == true) { // Assuming there's a method to check if the item is playing
        ...
        return when (viewType) {
            VIEW_TYPE_TEXT -> {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.text_comment_reply, parent, false)
                TextViewHolder(view)
            }

            VIEW_TYPE_AUDIO -> {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.audio_comment_item_reply, parent, false)
                AudioViewHolder(view)
            }

            VIEW_TYPE_IMAGE -> {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.image_comment_item_reply, parent, false)
                ImageViewHolder(view)
            }

            VIEW_TYPE_VIDEO -> {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.video_comment_item_reply, parent, false)
                VideoViewHolder(view)
            }

            VIEW_TYPE_DOCUMENT -> {
                val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.document_comment_item_reply, parent, false)
