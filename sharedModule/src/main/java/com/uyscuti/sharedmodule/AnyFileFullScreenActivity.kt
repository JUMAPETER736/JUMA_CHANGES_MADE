...
import com.uyscuti.sharedmodule.databinding.ActivityAnyFileFullScreenBinding
...
class AnyFileFullScreenActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityAnyFileFullScreenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAnyFileFullScreenBinding.inflate(layoutInflater)
    ...
    private fun setupMediaViewer(
        ...
        mediaPagerAdapter = MultipleFeedFilesPagerAdapter(this).apply {
            setMixedFeedUploadDataClass2(mediaItems)
        }
