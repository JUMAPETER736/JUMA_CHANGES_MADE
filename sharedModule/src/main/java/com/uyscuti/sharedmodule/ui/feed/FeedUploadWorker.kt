package com.uyscuti.sharedmodule.ui.feed
...
import com.uyscuti.sharedmodule.model.feed.Duration
import com.uyscuti.sharedmodule.model.feed.FileName
import com.uyscuti.sharedmodule.model.feed.FileSize
import com.uyscuti.sharedmodule.model.feed.FileType
import com.uyscuti.sharedmodule.model.feed.NumberOfPages
import com.uyscuti.sharedmodule.model.feed.ThumbnailWithString
import com.uyscuti.sharedmodule.shorts.UniqueIdGenerator
import com.uyscuti.sharedmodule.utils.commaSeparatedStringToList
import com.uyscuti.sharedmodule.utils.createRequestBodies
import com.uyscuti.sharedmodule.utils.feedutils.createTempFileFromFile
import com.uyscuti.sharedmodule.utils.feedutils.deleteTemporaryFiles
import com.uyscuti.sharedmodule.utils.feedutils.deserializeFeedUploadDataList
import com.uyscuti.sharedmodule.utils.feedutils.getFileExtension
            ...
            if (contentType == "mixed_files") {
                ...
                if (uploadDataJson != null) {
                    ...
                    return if (uploadResult) {
                        ...
                        Log.d(TAG, "Failed to upload mixed files")
                        EventBus.getDefault().post(UploadSuccessful(success = true))
                        Result.failure()
                    }
                }
                ...
                return if (uploadResult) {
                    ...
                    Log.d(TAG, "Failed to upload docs")
                    Result.failure()
                }
                ...
                return if (uploadResult) {
                    ...
                    Log.d(TAG, "Failed to upload multiple video files")
                    Result.failure()
                }
                ...
                return if (uploadResult) {
                    ...
                    Log.d(TAG, "Failed to upload thumbnail")
                    Result.failure()
                }
                ...
                return if (uploadResult) {
                    ...
                    Log.d(TAG, "Failed to upload multiple images")
                    Result.failure()
                }
            } else if (contentType == "audio") {

                Log.d(TAG, "doWork: content type is audio")
                ...
                return if (uploadResult) {
                    ...
                    Log.d(TAG, "Failed to upload audio")
                    Result.failure()
                }
            } else {
                val file = filePath?.let { File(it) }
