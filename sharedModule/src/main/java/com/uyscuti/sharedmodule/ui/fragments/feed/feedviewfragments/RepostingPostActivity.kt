...
import com.uyscuti.sharedmodule.databinding.ActivityRepostingPostBinding
            ...
            when (data.contentType) {
                ...
                "mixed_files" -> {
                    ...
                    if (data.originalPost.isNotEmpty()) {
                        ...
                        binding.recyclerView2.visibility = View.GONE // Hide RecyclerView if no OriginalPost exists
                    }
