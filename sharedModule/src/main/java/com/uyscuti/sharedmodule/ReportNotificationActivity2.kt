    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reportReasons.setOnCheckedChangeListener { _, checkedId ->
            ...
            nextButton.backgroundTintList = if (checkedId != -1) {
                ColorStateList.valueOf(resources.getColor(R.color.bluejeans)) // Enable with blue
            } else {
                ColorStateList.valueOf(resources.getColor(R.color.gray_dark)) // Disable with gray
            }
        }
