...
data class ShowBottomNav(val bool: Boolean = true)
data class HideBottomNav(val bool: Boolean = true)
data class ShowAppBar(val bool: Boolean = true)
data class HideAppBar(val bool: Boolean = true)
...
data class BusinessCommentClicked(
    val position: Int,
    val post: com.uyscuti.social.network.api.response.business.response.post.Post
)

data class GetShortFragments(
    var arguments: Bundle
)

data class ActivityCreateEvent(
    var activity: Activity? = null
)

data class GetActivityReferenceEvent(
    var activity: Activity? = null
)
class NavigateToMainEvent
