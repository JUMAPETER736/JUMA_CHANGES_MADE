package com.uyscuti.social.circuit.data.fixtures;
...
public final class DialogsFixtures extends FixturesData {
    ...
    public static ArrayList<User> getRandomUsers() {
        ArrayList<User> users = new ArrayList<>();

        int numberOfUsers = 3 + rnd.nextInt(10); // Generates a random number between 1 and 4
