...
class StringViewHolder @OptIn(UnstableApi::class) constructor(
    ...
    private val shortsProfileImage: ImageView = itemView.findViewById(R.id.profileImageForShort)
...
class ShotsFragment : Fragment(), OnClickListeners {
    ...
    override fun onCreateView(
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            shortsAdapter =
                ShortsAdapter(
                    requireActivity() as OnCommentsClickListener, this@ShotsFragment,
                    exoPlayer!!, object :
    ...
    override fun onShareClick(position: Int) {
        ...
        val binding = BottomDialogForShareBinding.inflate(layoutInflater)
