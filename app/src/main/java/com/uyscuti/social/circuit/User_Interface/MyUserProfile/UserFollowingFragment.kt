...
class UserFollowingFragment : AppCompatActivity() {
    ...
    private fun navigateToUserProfile(user: UserFollowingDisplayModel) {
        Log.d(TAG, "Navigate to profile: ${user.username}")

        try {
            val intent = Intent(this, MyUserProfileAccount::class.java).apply {
...
class FollowingAdapter(
    ...
    inner class FollowingViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val sendMessage: MaterialButton = view.findViewById(R.id.sendMessage)
    ...
    override fun onBindViewHolder(holder: FollowingViewHolder, position: Int) {
        ...
        holder.sendMessage.backgroundTintList = ContextCompat.getColorStateList(
        ...
        holder.sendMessage.setOnClickListener { onUnfollowClick(followingUser) }
...
class BlockedAdapter(
    ...
    inner class BlockedViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val usernameText: TextView = view.findViewById(R.id.usernameText)
        val fullNameText: TextView = view.findViewById(R.id.full_name)
        val actionButton: MaterialButton = view.findViewById(R.id.sendMessage)
        val moreOptionsButton: MaterialButton = view.findViewById(R.id.moreOptionsButton)
    }
