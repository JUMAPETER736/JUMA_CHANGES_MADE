...
import com.uyscuti.social.circuit.eventbus.InformFeedFragment
...
import com.uyscuti.social.circuit.ui.fragments.feed.UploadFeedActivity
...
import com.uyscuti.social.circuit.viewmodels.feed.FeedUploadProgressViewModel
import com.uyscuti.social.circuit.viewmodels.feed.GetFeedViewModel
import com.uyscuti.social.circuit.views.WaveFormView
...
import com.uyscuti.social.network.api.response.allFeedRepostsPost.RepostedUser
...
// =============================================================================
    ...
    // =============================================================================
// UI COMPONENTS - VOICE NOTE RECORDING
// =============================================================================
    ...
    // =============================================================================
// UI COMPONENTS - VOICE NOTE TIMER & WAVEFORM
// =============================================================================
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_UPLOAD_FEED_ACTIVITY) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                // Process files and create post object (existing logic)
                val filesList = ArrayList<com.uyscuti.social.network.api.response.getfeedandresposts.File>()
                ...
                val avatar = Avatar(_id = "", localPath = "", url = "", type = "")
                val account = Account(
                    _id = "", avatar = avatar, createdAt = "", email = "", updatedAt = "",
                    LocalStorage.getInstance(requireContext()).getUsername()
                )
                val author = Author(
                    _id = userId, account = account, firstName = "", lastName = "", bio = "",
                    countryCode = "", createdAt = "", __v = 0, dob = "", owner = "", location = "",
                    updatedAt = "", phoneNumber = "", avatar = null,
                    coverImage = CoverImage(_id = "", localPath = "", url = profilePic2),
                    username = "unknown"
                )
                ...
                dataList.forEach {
                    ...
                    if (it.documents != null) {
                        ...
                        thumbnail.add(
                            Thumbnail(
                                _id = "", thumbnailUrl = it.videos!!.videoPath,
                ...
                val post = Post(
                    ...
                    repostedUser = RepostedUser(
                        _id = "",
                        avatar = Avatar(_id = "", localPath = "", url = "", type = ""),
                        createdAt = "",
                        email = "",
                        updatedAt = "",
                        username = "",
                    ...
                    isFromMutualFriend = false,
                    isFromCloseFriend = false,
