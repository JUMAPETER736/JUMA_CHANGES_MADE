...
class MyUserProfileAccount : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityMyUserProfileAccountBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMyUserProfileAccountBinding.inflate(layoutInflater)
    ...
    inner class MyUserProfilePagerAdapter(
        ...
        val storedAvatarUrl = getAvatarUrl(activity)
