...
import com.uyscuti.social.circuit.adapter.ProfileTabsAdapter
...
import com.uyscuti.social.circuit.databinding.OtherUserProfileRedesignBinding
import com.uyscuti.social.circuit.eventbus.FromOtherUsersFeedCommentClick
import com.uyscuti.social.circuit.eventbus.HideToolBar
...
import com.uyscuti.social.circuit.ui.shorts.OtherUserProfileShortsPlayerFragment
import com.uyscuti.social.circuit.ui.shorts.UniqueIdGenerator
import com.uyscuti.social.circuit.ui.shorts.getFileSize
import com.uyscuti.social.circuit.ui.testui.TrialFragment
...
//        supportActionBar?.title = user?.name ?: fromShortsUserAccount?.username ?: "Default Title"
        ...
        val user = com.uyscuti.social.business.model.User(
...
//    }
    ...
    companion object {
        ...
        fun open(context: Context, user: User, dialogPhone: String, dialogId: String) {
...
//            audios = mutableListOf(vnFile),
        ...
        val replyCount = data!!.replyCount + 1
        val commentWithReplies = Comment(__v = data!!.__v,
            _id = data!!._id,
            author = data!!.author,
            content = data!!.content,
            createdAt = data!!.createdAt,
