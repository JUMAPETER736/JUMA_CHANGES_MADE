package com.uyscuti.social.circuit.ui.fragments.feed.feedviewfragments
...
import com.uyscuti.social.circuit.databinding.FragmentFeedRepostFilesBinding
 ...
 * Use the [FeedRepostFilesFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
private const val TAG = "FeedRepostFilesFragment"

class FeedRepostFilesFragment : Fragment(), FeedTextViewFragmentInterface {
    ...
    private lateinit var  binding: FragmentFeedRepostFilesBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        arguments?.let {
            param1 = it.getString(ARG_PARAM1)
            param2 = it.getString(ARG_PARAM2)
            data = (it.getSerializable("feedPost") as  com.uyscuti.social.network.api.response.allFeedRepostsPost.OriginalPost?)!!
...
//        }
    ...
    private fun setDocument( ) {
        ...
        if (numberOfPages != null) {
            binding.numberOfPages.text = numberOfPages.numberOfPage
        }
        if (thumbnailItem != null) {
            Glide.with(this)
                .load(thumbnailItem.thumbnailUrl)
    ...
    companion object {
         ...
         * @return A new instance of fragment FeedRepostFilesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FeedRepostFilesFragment().apply {
   ...
   override fun backPressedFromFeedTextViewFragment() {
    ...
    override fun onCommentClickFromFeedTextViewFragment(position: Int, data: com.uyscuti.social.network.api.response.allFeedRepostsPost.Post) {


    }

    override fun onLikeUnLikeFeedFromFeedTextViewFragment(position: Int, data: com.uyscuti.social.network.api.response.allFeedRepostsPost.Post) {


    }

    override fun onFeedFavoriteClickFromFeedTextViewFragment(position: Int, data: com.uyscuti.social.network.api.response.allFeedRepostsPost.Post) {


    }

    override fun onMoreOptionsClickFromFeedTextViewFragment(position: Int, data: com.uyscuti.social.network.api.response.allFeedRepostsPost.Post) {
