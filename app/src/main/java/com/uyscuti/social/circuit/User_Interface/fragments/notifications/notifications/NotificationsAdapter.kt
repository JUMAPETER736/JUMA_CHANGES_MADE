...
//import com.uyscut.core.common.data.room.database.NotificationDataBase
...
//import com.uyscut.flashdesign.ReportNotificationActivity2
...
//import com.uyscuti.social.circuit.ui.OtherUserProfile
...
////only the below code  is used for notifications
...
//            }
//            /**The notification being used are these the others above are not used*/
...
//                holder.itemView.setBackgroundResource(R.color.notificationLayout)
...
//            holder.itemView.setBackgroundColor(holder.itemView.context.getColor(com.uyscut.chatsuit.R.color.transparent))
...
//                    .into(holder.profilePic)
//
//                /** follow function is added here */
//                var isFollowing = true // Initial state
//                if (isFollowing) {
...
//                        isFollowing = true
//                    }
//                    val followUnFollowEntity =
//                        FollowUnFollowEntity(notificationItem.owner, false)
//                    EventBus.getDefault().post(ShortsFollowButtonClicked(followUnFollowEntity))
//                }
//                /** profilePic listener is here */
...
////                holder.username.text = notificationItem.name
////
////                val originalPostContent = notificationItem.originalPostContent
////                holder.originalPostContent.text = if (originalPostContent.length>40){
////                    originalPostContent.substring(0,20)
////                }else{
////                    originalPostContent
//                if (notificationItem.avatar.isNotEmpty()) {
//                    Log.w(
...
//                    fullMessage
//                }
//                holder.notificationDetails.text = truncatedMessage
////                holder.username1.text = notificationItem.
//                if (notificationItem.avatar.isNotEmpty()) {
//                    Log.w(
//                        "LikeNotification",
//                        "Avatar URL is empty or null for LikeNotification: $notificationItem"
...
//        if (view == null) return
//        val popupMenu = androidx.appcompat.widget.PopupMenu(view.context, view, Gravity.END)
...
//            "follow" -> NOTIFICATION_TYPE_WITH_FOLLOW
...
//    // Add image views or other views for image type
//    val followButton: AppCompatButton = itemView.findViewById(R.id.btnFollow)
//    val notificationMessage: TextView = itemView.findViewById(R.id.notificationMessage)
//    val username: TextView = itemView.findViewById(R.id.username)
//    val profilePic: ImageView = itemView.findViewById(R.id.profilePic1)
...
//    val notificationDetails: TextView = itemView.findViewById(R.id.user_details)
//    val profilePicture: ImageView = itemView.findViewById(R.id.profilePic1)
//    val username1: TextView = itemView.findViewById(R.id.username_details)
//    val btnFollow: AppCompatButton = itemView.findViewById(R.id.btnFollow)
//    val notificationTime: TextView = itemView.findViewById(R.id.notificationTime)
//}
//
//
