...
interface NavigationController {
    ...
    fun navigate(id: String, title: String)
...
fun Activity.getNavigationController() = this as NavigationController
//fun FragmentPagerAdapter.getNavigationController() = FragmentPagerAdapter() as NavigationController
