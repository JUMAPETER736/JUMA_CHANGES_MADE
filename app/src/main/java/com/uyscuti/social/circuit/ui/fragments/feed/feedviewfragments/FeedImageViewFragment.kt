...
import com.uyscuti.social.circuit.databinding.FragmentFeedImageViewBinding
 ...
 * Use the [FeedImageViewFragment.newInstance] factory method to
 * create an instance of this fragment.
 */

private const val TAG = "FeedImageViewFragment"

class FeedImageViewFragment : Fragment() {
    ...
    private lateinit var binding: FragmentFeedImageViewBinding
...
//        enterTransition = inflater.inflateTransition(R.transition.feed_slide_from_top)
        arguments?.let {
            ...
            data = (it.getSerializable("data") as  com.uyscuti.social.network.api.response.allFeedRepostsPost.Post?)!! // Adjust type if needed
        }
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentFeedImageViewBinding.inflate(inflater, container, false)
...
//        binding.feedCommentsCount.text = data.comments.size.toString()
    ...
    companion object {
         ...
         * @param param2 Parameter 2.replace
         * @param param2 Parameter 2.replace
         * @return A new instance of fragment FeedImageViewFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FeedImageViewFragment().apply {
