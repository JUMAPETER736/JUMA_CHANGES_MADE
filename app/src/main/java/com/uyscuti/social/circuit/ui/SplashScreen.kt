...
//    private lateinit var shortsViewModel: ShortsViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialogRepository = DialogRepository(
            ChatDatabase.getInstance(this).dialogDao(),
            retrofitInstance,
            localStorage
        )
        messageRepository =
            MessageRepository(this, ChatDatabase.getInstance(this).messageDao(), retrofitInstance)
...
//        })
        ...
        Log.d(TAG, "onCreate token: ${LocalStorage.getInstance(this).getToken()}")
