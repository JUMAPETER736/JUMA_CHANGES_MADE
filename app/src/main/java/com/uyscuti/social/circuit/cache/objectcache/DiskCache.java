...
//import com.uyscuti.banji.libs.cache.diskcatche.DiskLruCache;


import com.uyscuti.social.circuit.cache.diskcatche.DiskLruCache;
...
public class DiskCache {
	...
	public void setKeyValue ( String key, String value ) throws IOException {
		...
		try {
			...
			Log.d("SoundPickerActivity", "Setting key value in disk cache");
	...
	protected boolean writeValueToCache ( String value, DiskLruCache.Editor editor ) throws IOException {
		...
		try {
			outputStream = new BufferedOutputStream(editor.newOutputStream(0),100);
	...
	protected String getHashOf ( String string ) throws UnsupportedEncodingException {
		try {
			Log.d("SoundPickerActivity", "getting hash in disk cache");
