...
import com.uyscuti.social.network.api.response.profile.followersList.Avatar as ApiAvatar
import java.text.SimpleDateFormat
import java.util.Date
import java.util.Locale

data class UserDisplayFollowersModel(
    val _id: String,
    ...
    companion object {
        ...
        fun fromApiData(data: Data, isFollowing: Boolean = false): UserDisplayFollowersModel {
            ...
            return UserDisplayFollowersModel(
                _id = data._id,
                avatar = avatarModel,
                email = data.email,
