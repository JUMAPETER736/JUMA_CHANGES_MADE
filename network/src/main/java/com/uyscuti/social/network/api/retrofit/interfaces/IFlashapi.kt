...
interface IFlashapi {
    ...
    * ============================================================ */
    ...
    suspend fun followUnFollow(
        @Path("toBeFollowedUserId") userId: String
    ...
    suspend fun createGroupChat(
        @Body request: RequestGroupChat
    ): Response<ResponseGroupChat>
    ...
    suspend fun uploadTextFeed(
        @Body body: FeedTextUploadRequestBody
    ): Response<FeedUploadResponse>
...
//    @Multipart
    ...
    suspend fun getFavoriteFeed(
        @Query("page") page: String,
    ): Response<FeedFavoriteResponse>

    @GET("feed/post/followed")
    suspend fun getFollowedPosts(@Query("page") page: String): Response<AllFeedRepostsPost>


//    @GET("feed/posts/get/my")
//    suspend fun myFeed(
//        @Query("page") page: String,
////        @Query("limit") limit: String
//    ): Response<GetAllFeedResponse>
...
//    @GET("social-media/comments/{commentId}")
//    suspend fun getOneComments(@Path("commentId") commentId: String): Response<GetOneCommentId>
